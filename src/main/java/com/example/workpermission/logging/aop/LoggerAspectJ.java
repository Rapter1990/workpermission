...
public class LoggerAspectJ {
    ...
    private String getHttpStatusFromException(Exception ex) {
        return switch (ex.getClass().getSimpleName()) {
            ...
            case "InsufficientLeaveDaysException" -> InsufficientLeaveDaysException.STATUS.name();
            case "InvalidLeavePeriodException" -> InvalidLeavePeriodException.STATUS.name();
            case "LeaveRequestNotFoundException" -> LeaveRequestNotFoundException.STATUS.name();
            case "NoAnnualLeaveStrategyFoundException" -> NoAnnualLeaveStrategyFoundException.STATUS.name();

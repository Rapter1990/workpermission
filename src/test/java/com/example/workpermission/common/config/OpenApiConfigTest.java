...
class OpenApiConfigTest {
    ...
    void openApiInfo() {
        ...
        assertEquals("workpermission", openAPIDefinition.info().title());
        assertEquals("Case Study - Work Permission" +
    ...
    void contactInfo() {
        ...
        assertEquals("https://github.com/Rapter1990/workpermission", contact.url());

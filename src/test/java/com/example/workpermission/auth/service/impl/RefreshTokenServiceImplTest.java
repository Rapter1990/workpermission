...
import com.example.workpermission.builder.TokenBuilder;
...
class RefreshTokenServiceImplTest extends AbstractBaseServiceTest {
    ...
    void refreshToken_ValidRefreshToken_ReturnsToken() {
        ...
        final UserEntity mockAdminUserEntity = new ManagerUserBuilder().withValidFields().build();
    ...
    void refreshToken_InactiveAdmin_ThrowsException() {
        ...
        UserEntity inactiveAdmin = new ManagerUserBuilder().withValidFields().withUserStatus(UserStatus.PASSIVE).build();
